...
BasicGame.Preloader.prototype = {
	...
	preload: function () {
		...
		this.load.atlas('glitchsprites', 'images/glitchsprites.png', 'images/glitchsprites.json');
        this.load.bitmapFont('Arial', 'images/ArialNumbers_0.png', 'images/ArialNumbers.fnt');



		//this.load.audio('titleMusic', ['audio/song_20131212_164749_599.ogg']);
